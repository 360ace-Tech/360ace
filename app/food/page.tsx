      ...
      <main className="relative z-10">
        <section ref={ref} className="pt-28 md:pt-32 pb-16 px-6 md:px-12 scroll-mt-32">
          <div className="mb-16 flex flex-col md:flex-row items-start md:items-end justify-between border-b border-[#E5E2D8] pb-6 gap-3">
            ...
            <a href="https://360ace.food" target="_blank" rel="noopener noreferrer" className="interactive group flex items-center gap-3 text-[#8F877B] hover:text-[#1C1917] transition-colors text-[10px] font-mono uppercase tracking-widest">
