...
4. **Deploy**
   ...
   - Cloudflare will automatically handle Next.js SSR and API routes

### Method 2: Wrangler CLI

```bash
# Deploy directly
npx wrangler pages deploy .next --project-name=360ace-net

# Or use the npm script
npm run deploy:cloudflare
```

**Note**: Cloudflare Pages natively supports Next.js with SSR and API routes. No additional configuration needed.
