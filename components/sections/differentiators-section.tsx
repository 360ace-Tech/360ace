...
export function DifferentiatorsSection() {
  return (
    <section id="differentiators" className="bg-[color:var(--color-background)] py-16 sm:py-20 scroll-mt-24">
        ...
        <StaggerContainer className="grid gap-6 md:grid-cols-3" staggerDelay={0.12}>
          {differentiators.map((item) => (
            <motion.article
              ...
              className="group rounded-[var(--radius-md)] border border-[color:var(--color-border)] bg-[color:var(--color-muted)]/40 p-6 sm:p-8 transition-all duration-300 hover:bg-[color:var(--color-muted)]/60 hover:shadow-md hover:shadow-black/10 hover:-translate-y-1"
            >
